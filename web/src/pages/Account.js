        ...
        <div className="container-account">
           <div className="box-account">
                ...
                <div id="account-options">
                        <span id="text-account">Alterar Senha<button className="btn-updatepass" onClick={mudandodisplay}><TiEdit style={{width: "30px", height: "30px"}} /></button> </span>
                        <span id="text-account">Alterar E-mail <button className="btn-updatepass"><TiEdit style={{width: "30px", height: "30px"}} /></button></span>
                </div>
